...
Upington -> N x Upington Loop (60.76 km each) -> Stage 2
Upington->Augrabies (114.47 km).
...
if __name__ == "__main__":
    ...
    if mode == "A":
        ...
        print("  python day5_strategy_loop1.py A <n_loops> <soc_at_control_stop_pct> <trailer_speed_kmh>")
        print("  python day5_strategy_loop1.py B <n_loops> <soc_at_departure_pct>")
        sys.exit(1)
    ...
    plt.tight_layout()
    out_png = DASH / f"day5_loop1_mode{result['mode']}_loops{result['n_loops']}_plots.png"
