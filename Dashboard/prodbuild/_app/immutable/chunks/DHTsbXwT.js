...
var fn = (i, t, e) => t in i ? dn(i, t, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: e
}) : i[t] = e;
var O = (i, t, e) => fn(i, typeof t != "symbol" ? t + "" : t, e);
/*!
 * @kurkle/color v0.3.4
...
function Wt(i) {
    return ct(ie(i * 2.55), 0, 255)
}
function ht(i) {
    return ct(ie(i * 255), 0, 255)
}
function rt(i) {
    return ct(ie(i / 2.55) / 100, 0, 1)
}
function pi(i) {
    return ct(ie(i * 100), 0, 100)
}
const U = {
    0: 0,
    1: 1,
  ...
  , Ye = [..."0123456789ABCDEF"]
  , un = i => Ye[i & 15]
  , gn = i => Ye[(i & 240) >> 4] + Ye[i & 15]
  , re = i => (i & 240) >> 4 === (i & 15)
  , pn = i => re(i.r) && re(i.g) && re(i.b) && re(i.a);
function mn(i) {
    var t = i.length, e;
...
const bn = (i, t) => i < 255 ? t(i) : "";
function _n(i) {
    var t = pn(i) ? un : gn;
    return i ? "#" + t(i.r) + t(i.g) + t(i.b) + bn(i.a, t) : void 0
}
const xn = /^(hsla?|hwb|hsv)\(\s*([-+.e\d]+)(?:deg)?[\s,]+([-+.e\d]+)%[\s,]+([-+.e\d]+)%(?:[\s,]+([-+.e\d]+)(%)?)?\s*\)$/;
function Ds(i, t, e) {
...
function Mn(i) {
    ...
    if (!t)
        return;
    t[5] !== s && (e = t[6] ? Wt(+t[5]) : ht(+t[5]));
    const n = Ps(+t[2])
      , o = +t[3] / 100
      , r = +t[4] / 100;
    return t[1] === "hwb" ? s = kn(n, o, r) : t[1] === "hsv" ? s = Sn(n, o, r) : s = ii(n, o, r),
    {
        r: s[0],
        g: s[1],
        b: s[2],
...
function An(i) {
    ...
    if (t) {
        if (t[7] !== s) {
            const r = +t[7];
            e = t[8] ? Wt(r) : ct(r * 255, 0, 255)
        }
        return s = +t[1],
        n = +t[3],
        o = +t[5],
        s = 255 & (t[2] ? Wt(s) : ct(s, 0, 255)),
        n = 255 & (t[4] ? Wt(n) : ct(n, 0, 255)),
        o = 255 & (t[6] ? Wt(o) : ct(o, 0, 255)),
        {
            r: s,
            g: n,
            b: o,
...
const Fe = i => i <= .0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - .055
  , Dt = i => i <= .04045 ? i / 12.92 : Math.pow((i + .055) / 1.055, 2.4);
function In(i, t, e) {
    const s = Dt(rt(i.r))
      , n = Dt(rt(i.g))
      , o = Dt(rt(i.b));
    return {
        r: ht(Fe(s + e * (Dt(rt(t.r)) - s))),
        g: ht(Fe(n + e * (Dt(rt(t.g)) - n))),
        b: ht(Fe(o + e * (Dt(rt(t.b)) - o))),
        a: i.a + e * (t.a - i.a)
    }
}
function le(i, t, e) {
...
class Gt {
    constructor(t) {
        ...
        const e = typeof t;
        let s;
        e === "object" ? s = _i(t) : e === "string" && (s = mn(t) || Cn(t) || Fn(t)),
        this._rgb = s,
        this._valid = !!s
    }
    get valid() {
    ...
    hslString() {
        return this._valid ? Dn(this._rgb) : void 0
    }
    mix(t, e) {
        if (t) {
            const s = this.rgb
    ...
    interpolate(t, e) {
        return t && (this._rgb = In(this._rgb, t._rgb, e)),
        this
    }
    clone() {
...
const Rn = (i, t) => typeof i == "string" && i.endsWith("%") ? parseFloat(i) / 100 * t : +i;
function F(i, t, e) {
...
function Bn(i, t, e) {
    ...
    const s = t[i]
      , n = e[i];
    C(s) && C(n) ? $t(s, n) : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = Se(n))
}
const xi = {
    "": i => i,
    x: i => i.x,
...
function Me(i, t) {
    return (xi[t] || (xi[t] = Wn(t)))(i)
}
function si(i) {
    return i.charAt(0).toUpperCase() + i.slice(1)
}
const Oe = i => typeof i < "u"
...
function wi(i) {
    ...
    i = Yt(i, t, i / 1e3) ? t : i;
    const e = Math.pow(10, Math.floor(As(i)))
      , s = i / e;
...
function Qt(i) {
    return !Yn(i) && !isNaN(parseFloat(i)) && isFinite(i)
}
function Un(i, t) {
...
const vt = (i, t, e, s) => ni(i, e, s ? n => {
    const o = i[n][t];
    return o < e || o === e && i[n + 1][t] === e
}
: n => i[n][t] < e)
  , Qn = (i, t, e) => ni(i, e, s => i[s][t] >= e);
function Jn(i, t, e) {
    let s = 0
      , n = i.length;
    for (; s < n && i[s] < t; )
...
const Is = ["push", "pop", "shift", "splice", "unshift"];
function to(i, t) {
    if (i._chartjs) {
...
const oi = i => i === "start" ? "left" : i === "end" ? "right" : "center"
  , W = (i, t, e) => i === "start" ? t : i === "end" ? e : (t + e) / 2
  , so = (i, t, e, s) => i === (s ? "left" : "right") ? e : i === "center" ? (t + e) / 2 : t;
function no(i, t, e) {
    const s = t.length;
    let n = 0
      , o = s;
    if (i._sorted) {
        const {iScale: r, vScale: a, _parsed: l} = i
          ...
          , h = r.axis
          , {min: d, max: f, minDefined: u, maxDefined: m} = r.getUserBounds();
        if (u) {
            if (n = Math.min(vt(l, h, d).lo, e ? s : vt(t, h, r.getPixelForValue(d)).lo),
            c) {
                const g = l.slice(0, n + 1).reverse().findIndex(p => !I(p[a.axis]));
                n -= Math.max(0, g)
            }
            n = X(n, 0, s - 1)
        }
        if (m) {
            ...
            if (c) {
                const p = l.slice(g - 1).findIndex(b => !I(b[a.axis]));
                g += Math.max(0, p)
            }
            o = X(g, n, s) - n
        } else
...
const ce = i => i === 0 || i === 1
  , Mi = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin((i - t) * it / e))
  , Oi = (i, t, e) => Math.pow(2, -10 * i) * Math.sin((i - t) * it / e) + 1
  , Ut = {
    linear: i => i,
    easeInQuad: i => i * i,
    easeOutQuad: i => -i * (i - 2),
    ...
    easeInSine: i => -Math.cos(i * Z) + 1,
    easeOutSine: i => Math.sin(i * Z),
    easeInOutSine: i => -.5 * (Math.cos(B * i) - 1),
    easeInExpo: i => i === 0 ? 0 : Math.pow(2, 10 * (i - 1)),
    easeOutExpo: i => i === 1 ? 1 : -Math.pow(2, -10 * i) + 1,
    easeInOutExpo: i => ce(i) ? i : i < .5 ? .5 * Math.pow(2, 10 * (i * 2 - 1)) : .5 * (-Math.pow(2, -10 * (i * 2 - 1)) + 2),
    easeInCirc: i => i >= 1 ? i : -(Math.sqrt(1 - i * i) - 1),
    easeOutCirc: i => Math.sqrt(1 - (i -= 1) * i),
    easeInOutCirc: i => (i /= .5) < 1 ? -.5 * (Math.sqrt(1 - i * i) - 1) : .5 * (Math.sqrt(1 - (i -= 2) * i) + 1),
    easeInElastic: i => ce(i) ? i : Mi(i, .075, .3),
    easeOutElastic: i => ce(i) ? i : Oi(i, .075, .3),
    easeInOutElastic(i) {
        return ce(i) ? i : i < .5 ? .5 * Mi(i * 2, .1125, .45) : .5 + .5 * Oi(i * 2 - 1, .1125, .45)
    },
    easeInBack(i) {
    ...
    easeInOutBounce: i => i < .5 ? Ut.easeInBounce(i * 2) * .5 : Ut.easeOutBounce(i * 2 - 1) * .5 + .5
};
function ri(i) {
...
function Di(i) {
    return ri(i) ? i : new Gt(i)
}
function ze(i) {
    return ri(i) ? i : new Gt(i).saturate(.5).darken(.1).hexString()
}
const ro = ["x", "y", "borderWidth", "radius", "tension"]
  , ao = ["color", "borderColor", "backgroundColor"];
function lo(i) {
    i.set("animation", {
        delay: void 0,
        duration: 1e3,
...
function Re(i, t, e) {
    return typeof t == "string" ? Zt(Xt(i, t), e) : Zt(Xt(i, ""), t)
}
class po {
    constructor(t, e) {
        ...
        this.hover = {},
        this.hoverBackgroundColor = (s, n) => ze(n.backgroundColor),
        this.hoverBorderColor = (s, n) => ze(n.borderColor),
        this.hoverColor = (s, n) => ze(n.color),
        this.indexAxis = "x",
        this.interaction = {
            mode: "nearest",
            intersect: !0,
...
function Bs(i, t, e, s, n) {
    ...
    const u = t.pointStyle
      ...
      , g = t.radius;
    let p = (m || 0) * Vn;
    if (u && typeof u == "object" && (o = u.toString(),
    ...
    if (!(isNaN(g) || g <= 0)) {
        ...
        u) {
        default:
            n ? i.ellipse(e, s, n / 2, g, 0, 0, it) : i.arc(e, s, g, 0, it),
            i.closePath();
            break;
        case "triangle":
            h = n ? n / 2 : g,
        ...
        case "rectRounded":
            ...
            l = g - c,
            r = Math.cos(p + gt) * l,
            d = Math.cos(p + gt) * (n ? n / 2 - c : l),
            a = Math.sin(p + gt) * l,
            f = Math.sin(p + gt) * (n ? n / 2 - c : l),
            i.arc(e - d, s - a, c, p - B, p - Z),
            i.arc(e + f, s - r, c, p - Z, p),
            i.arc(e + d, s + a, c, p, p + Z),
            i.arc(e - f, s + r, c, p + Z, p + B),
            i.closePath();
            break;
        case "rect":
            if (!m) {
            ...
            p += gt;
        case "rectRot":
            d = Math.cos(p) * (n ? n / 2 : g),
            r = Math.cos(p) * g,
            a = Math.sin(p) * g,
            f = Math.sin(p) * (n ? n / 2 : g),
            i.moveTo(e - d, s - a),
            i.lineTo(e + f, s - r),
            i.lineTo(e + d, s + a),
            i.lineTo(e - f, s + r),
        ...
        case "dash":
            i.moveTo(e, s),
            i.lineTo(e + Math.cos(p) * (n ? n / 2 : g), s + Math.sin(p) * g);
            break;
        case !1:
            i.closePath();
            break
...
function xo(i, t) {
    ...
    I(t.rotation) || i.rotate(t.rotation),
...
function te(i, t, e, s, n, o={}) {
    ...
    l = 0; l < r.length; ++l)
        c = r[l],
        o.backdrop && vo(i, o.backdrop),
        a && (o.strokeColor && (i.strokeStyle = o.strokeColor),
        I(o.strokeWidth) || (i.lineWidth = o.strokeWidth),
...
function qe(i, t) {
    ...
    i.arc(e + r.bottomLeft, s + o - r.bottomLeft, r.bottomLeft, B, Z, !0),
    i.lineTo(e + n - r.bottomRight, s + o),
    i.arc(e + n - r.bottomRight, s + o - r.bottomRight, r.bottomRight, Z, 0, !0),
    i.lineTo(e + n, s + r.topRight),
    i.arc(e + n - r.topRight, s + r.topRight, r.topRight, 0, -Z, !0),
    i.lineTo(e + r.topLeft, s)
}
const wo = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/
  , ko = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function So(i, t) {
    const e = ("" + i).match(wo);
    if (!e || e[1] === "normal")
        return t * 1.2;
...
function Kt(i) {
    return Hs(i, ["topLeft", "topRight", "bottomLeft", "bottomRight"])
}
function G(i) {
    const t = Oo(i);
...
function N(i, t) {
    ...
    s && !("" + s).match(ko) && (console.warn('Invalid font style specified: "' + s + '"'),
    s = void 0);
    const n = {
        family: P(i.family, t.family),
        lineHeight: So(P(i.lineHeight, t.lineHeight), e),
        size: e,
        style: s,
        weight: P(i.weight, t.weight),
        string: ""
    };
    return n.string = mo(n),
    n
}
function he(i, t, e, s) {
    let n, o, r;
...
const Po = (i, t) => i ? i + si(t) : t
  , hi = (i, t) => C(t) && i !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
function Ns(i, t, e) {
...
function Co(i, t, e) {
    ...
    let a = s[t];
    return dt(a) && r.isScriptable(t) && (a = To(t, a, i, e)),
    E(a) && a.length && (a = Ao(t, a, i, r.isIndexable)),
    hi(t, a) && (a = Tt(a, n, o && o[t], r)),
    a
}
function To(i, t, e, s) {
...
const Lo = (i, t) => i === !0 ? t : typeof i == "string" ? Me(t, i) : void 0;
function Io(i, t, e, s, n) {
    for (const o of t) {
        const r = Lo(e, o);
        if (r) {
            i.add(r);
            const a = js(r._fallback, e, n);
...
function di(i, t, e, s) {
    const n = t._rootScopes
      , o = js(t._fallback, e, s)
      , r = [...i, ...n]
      , a = new Set;
    a.add(s);
    let l = Ai(a, r, e, o || e, s);
    return l === null || typeof o < "u" && o !== e && (l = Ai(a, r, o, l, s),
    l === null) ? !1 : ci(Array.from(a), [""], n, o, () => Fo(t, e, s))
}
...
function Li(i) {
    let t = i._keys;
    return t || (t = i._keys = Ro(i._scopes)),
    t
}
function Ro(i) {
    const t = new Set;
...
function No(i, t="x") {
    ...
    for (r = 0; r < s; ++r)
        ...
        !!l) {
            ...
            o[r] = a ? c ? Ct(n[r - 1]) !== Ct(n[r]) ? 0 : (n[r - 1] + n[r]) / 2 : n[r - 1] : n[r]
        }
    Ho(i, n, o),
    Wo(i, o, t)
}
...
function jo(i, t) {
    ...
    s = i.length; e < s; ++e)
        ...
        a = e < s - 1 && Jt(i[e + 1], t),
        o && (n = i[e],
        r && (n.cp1x = de(n.cp1x, t.left, t.right),
        n.cp1y = de(n.cp1y, t.top, t.bottom)),
        a && (n.cp2x = de(n.cp2x, t.left, t.right),
        n.cp2y = de(n.cp2y, t.top, t.bottom)))
}
function Vo(i, t, e, s, n) {
    ...
    t.cubicInterpolationMode === "monotone")
        ...
        r = i.length; o < r; ++o)
            a = i[o],
            l = Bo(c, a, i[Math.min(o + 1, r - (s ? 0 : 1)) % r], t.tension),
            a.cp1x = l.previous.x,
            a.cp1y = l.previous.y,
            a.cp2x = l.next.x,
            a.cp2y = l.next.y,
...
const Yo = ["top", "right", "bottom", "left"];
function wt(i, t, e) {
    const s = {};
    e = e ? "-" + e : "";
    for (let n = 0; n < 4; n++) {
...
const Uo = (i, t, e) => (i > 0 || t > 0) && (!e || !e.shadowRoot);
function Xo(i, t) {
    const e = i.touches
      , s = e && e.length ? e[0] : i
...
function qo(i, t, e, s) {
    const n = Ae(i)
      , o = wt(n, "margin")
      , r = Pe(n.maxWidth, i, "clientWidth") || De
      , a = Pe(n.maxHeight, i, "clientHeight") || De
      , l = Ko(i, t, e);
    let {width: c, height: h} = l;
    if (n.boxSizing === "content-box") {
        const f = wt(n, "border", "width")
          , u = wt(n, "padding");
        c -= u.width + f.width,
        h -= u.height + f.height
    }
    ...
    c = fe(Math.min(c, r, l.maxWidth)),
    h = fe(Math.min(h, a, l.maxHeight)),
    c && !h && (h = fe(c / 2)),
...
const Go = (function() {
    ...
    try {
        ...
        fi() && (window.addEventListener("test", null, t),
...
function zi({start: i, end: t, count: e, loop: s, style: n}) {
    return {
        start: i % e,
        end: t % e,
        loop: s && (t - i + 1) % e === 0,
...
function ir(i, t, e) {
    ...
    const {property: s, start: n, end: o} = e
      , r = t.length
      , {compare: a, between: l, normalize: c} = Xs(s)
      , {start: h, end: d, loop: f, style: u} = er(i, t, e)
      , m = [];
    let g = !1, p = null, b, x, v;
    const w = () => l(n, v, b) && a(n, v) !== 0
      , _ = () => a(o, b) === 0 || l(o, v, b)
      , S = () => g || w()
      , k = () => !g || _();
    for (let y = h, M = h; y <= d; ++y)
        x = t[y % r],
        !x.skip && (b = c(x[s]),
        b !== v && (g = l(b, n, o),
        p === null && S() && (p = a(b, n) === 0 ? y : M),
        p !== null && k() && (m.push(zi({
            start: p,
            end: y,
            loop: f,
...
function lr(i, t) {
    ...
    const e = []
      , s = function(n, o) {
        return ri(o) ? (e.includes(o) || e.push(o),
        e.indexOf(o)) : o
    };
...
class ur {
    constructor(t, e, s, n) {
        const o = e[s];
        n = he([t.to, n, o, t.from]);
        const r = he([t.from, o, n]);
        this._active = !0,
        this._fn = t.fn || fr[t.type || typeof r],
    ...
    update(t, e, s) {
        if (this._active) {
            ...
            this._total += o,
            this._loop = !!t.loop,
            this._to = he([t.to, e, n, t.from]),
            this._from = he([t.from, n, e])
        }
    }
    cancel() {
...
class Ks {
    ...
    configure(t) {
        ...
        Object.getOwnPropertyNames(t).forEach(n => {
            ...
            for (const a of e)
                r[a] = o[a];
            (E(o.properties) && o.properties || [n]).forEach(a => {
    ...
    _animateOptions(t, e) {
        ...
        return s.$shared && gr(t.options.$animations, s).then( () => {
            t.options = s
        }
        , () => {}
        ),
...
function ji(i, t) {
    ...
    for (let u = 0; u < d; ++u) {
        ...
        f = b[c] = vr(n, h, g),
        f[a] = p,
        f._top = Ni(f, r, !0, s.type),
        f._bottom = Ni(f, r, !1, s.type);
...
const He = i => i === "reset" || i === "none"
  , Vi = (i, t) => t ? i : Object.assign({}, i)
  , Sr = (i, t, e) => i && !t.hidden && t._stacked && {
    keys: qs(e, !0),
    values: null
};
class qt {
    ...
    updateIndex(t) {
        this.index !== t && zt(this._cachedMeta),
        this.index = t
    }
    linkScales() {
        const t = this.chart
          , e = this._cachedMeta
          , s = this.getDataset()
          , n = (d, f, u, m) => d === "x" ? f : d === "r" ? m : u
          , o = e.xAxisID = P(s.xAxisID, Be(t, "x"))
          , r = e.yAxisID = P(s.yAxisID, Be(t, "y"))
          , a = e.rAxisID = P(s.rAxisID, Be(t, "r"))
          , l = e.indexAxis
    ...
    _dataCheck() {
        ...
        if (C(e)) {
            ...
            e && Object.isExtensible(e) && to(e, this),
            this._syncList = [],
            this._data = e
        }
    }
    ...
    buildOrUpdateElements(t) {
        ...
        (n || o !== e._stacked) && (ji(this, e._parsed),
        e._stacked = Ee(e.vScale, e))
    }
    configure() {
    ...
    parse(t, e) {
        ...
        if (this._parsing === !1)
            ...
            E(n[t]) ? f = this.parseArrayData(s, n, t, e) : C(n[t]) ? f = this.parseObjectData(s, n, t, e) : f = this.parsePrimitiveData(s, n, t, e);
    ...
    updateRangeFromParsed(t, e, s, n) {
        ...
        n && a && (n.values = a,
        r = Wi(n, o, this._cachedMeta.index)),
    ...
    getMinMax(t, e) {
        ...
        function m() {
            u = n[f];
            const g = u[a.axis];
            return !q(u[t.axis]) || h > g || d < g
        }
        for (f = 0; f < r && !(!m() && (this.updateRangeFromParsed(c, t, u, l),
        o)); ++f)
            ;
        if (o) {
            for (f = r - 1; f >= 0; --f)
    ...
    _update(t) {
        ...
        e._clip = br(P(this.options.clip, mr(e.xScale, e.yScale, this.getMaxOverflow())))
    }
    update(t) {}
    draw() {
        const t = this._ctx
    ...
    getContext(t, e, s) {
        ...
        if (t >= 0 && t < this._cachedMeta.data.length) {
            ...
            o = r.$context || (r.$context = kr(this.getContext(), t, r)),
            o.parsed = this.getParsed(t),
            o.raw = n.data[t],
            o.index = o.dataIndex = t
        } else
            o = this.$context || (this.$context = wr(this.chart.getContext(), this.index)),
            o.dataset = n,
    ...
    _resolveElementOptions(t, e="default", s) {
        const n = e === "active"
          ...
          , r = t + "-" + e
          , a = o[r]
          , l = this.enableOptionSharing && Oe(s);
        if (a)
            return Vi(a, l);
        const c = this.chart.config
          ...
          , m = () => this.getContext(s, n, e)
          , g = c.resolveNamedOptions(f, u, m, d);
        return g.$shared && (g.$shared = l,
        o[r] = Object.freeze(Vi(g, l))),
        g
    }
    ...
    includeOptions(t, e) {
        return !e || He(t) || this.chart._animationsDisabled
    }
    ...
    updateElement(t, e, s, n) {
        He(n) ? Object.assign(t, s) : this._resolveAnimations(e, n).update(t, s)
    }
    updateSharedOptions(t, e, s) {
        t && !He(e) && this._resolveAnimations(void 0, e).update(t, s)
    }
    _setStyle(t, e, s, n) {
        t.active = n;
...
O(qt, "defaults", {}),
O(qt, "datasetElementType", null),
O(qt, "dataElementType", null);
class We extends qt {
    initialize() {
    ...
    updateElements(t, e, s, n) {
        const o = n === "reset"
          ...
          , p = Qt(m) ? m : Number.POSITIVE_INFINITY
        ...
        for (let _ = 0; _ < v; ++_) {
            ...
            const y = this.getParsed(_)
              , M = I(y[u])
              , T = k[f] = r.getPixelForValue(y[f], _)
              , D = k[u] = o || M ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, y, l) : y[u], _);
            k.skip = isNaN(T) || isNaN(D) || M,
            k.stop = _ > 0 && Math.abs(y[f] - w[f]) > p,
            g && (k.parsed = y,
            k.raw = c.data[_]),
            d && (k.options = h || this.resolveDataElementOptions(_, S.active ? "active" : n)),
            b || this.updateElement(S, _, k, n),
            w = y
        }
    }
    getMaxOverflow() {
...
function Or(i, t, e, s) {
    ...
    if (a && t === a.axis && t !== "r" && r && o.length) {
        const c = a._reversePixels ? Qn : vt;
        if (s) {
            if (n._sharedOptions) {
                const h = o[0]
            ...
            if (l) {
                const {vScale: d} = n._cachedMeta
                  , {_parsed: f} = i
                  , u = f.slice(0, h.lo + 1).reverse().findIndex(g => !I(g[d.axis]));
                h.lo -= Math.max(0, u);
                const m = f.slice(h.hi).findIndex(g => !I(g[d.axis]));
                h.hi += Math.max(0, m)
            }
            return h
        }
...
function Ne(i, t, e, s, n) {
    const o = [];
    return !n && !i.isPointInArea(t) || Le(i, e, t, function(a, l, c) {
...
function je(i, t, e, s, n, o) {
    return !o && !i.isPointInArea(t) ? [] : e === "r" && !s ? Pr(i, t, e, n) : Cr(i, t, e, s, n, o)
}
function $i(i, t, e, s, n) {
    const o = []
      , r = e === "x" ? "inXRange" : "inYRange";
    let a = !1;
    return Le(i, e, t, (l, c, h) => {
    ...
    modes: {
        index(i, t, e, s) {
            const n = bt(t, i)
              ...
              , a = e.intersect ? Ne(i, n, o, s, r) : je(i, n, o, !1, s, r)
              , l = [];
        ...
        dataset(i, t, e, s) {
            const n = bt(t, i)
              , o = e.axis || "xy"
              , r = e.includeInvisible || !1;
            let a = e.intersect ? Ne(i, n, o, s, r) : je(i, n, o, !1, s, r);
            if (a.length > 0) {
        ...
        nearest(i, t, e, s) {
            const n = bt(t, i)
              , o = e.axis || "xy"
              , r = e.includeInvisible || !1;
            return je(i, n, o, e.intersect, s, r)
        },
        x(i, t, e, s) {
            const n = bt(t, i);
...
function Yi(i, t) {
    return i.filter(e => Gs.indexOf(e.pos) === -1 && e.box.axis === t)
}
function Et(i, t) {
    return i.sort( (e, s) => {
        const n = t ? s : e
...
function Fr(i) {
    const t = Ar(i)
      , e = Et(t.filter(c => c.box.fullSize), !0)
      , s = Et(Rt(t, "left"), !0)
      , n = Et(Rt(t, "right"))
      , o = Et(Rt(t, "top"), !0)
      , r = Et(Rt(t, "bottom"))
...
function zr(i, t, e, s) {
    ...
    const a = Math.max(0, t.outerWidth - Ui(r, i, "left", "right"))
      , l = Math.max(0, t.outerHeight - Ui(r, i, "top", "bottom"))
      , c = a !== i.w
      , h = l !== i.h;
    return i.w = a,
    i.h = l,
...
function jt(i, t, e, s) {
    ...
    c = 0; o < r; ++o) {
        a = i[o],
        l = a.box,
        l.update(a.width || t.w, a.height || t.h, Er(a.horizontal, t));
        const {same: d, other: f} = zr(t, e, a, s);
        c |= d && n.length,
        h = h || f,
        l.fullSize || n.push(a)
    }
...
function Xi(i, t, e, s) {
    ...
    for (const a of i) {
        ...
        if (a.horizontal) {
            const d = t.w * h
              , f = c.size || l.height;
            Oe(c.start) && (r = c.start),
            l.fullSize ? ge(l, n.left, r, e.outerWidth - n.right - n.left, f) : ge(l, t.left + c.placed, r, d, f),
            c.start = r,
            c.placed += d,
            r = l.bottom
        } else {
            const d = t.h * h
              , f = c.size || l.width;
            Oe(c.start) && (o = c.start),
            l.fullSize ? ge(l, o, n.top, f, e.outerHeight - n.bottom - n.top) : ge(l, o, t.top + c.placed, f, d),
            c.start = o,
            c.placed += d,
            o = l.right
        }
...
var K = {
    ...
    update(i, t, e, s) {
        ...
        const h = l.reduce( (g, p) => p.box.options && p.box.options.display === !1 ? g : g + 1, 0) || 1
          , d = Object.freeze({
            outerWidth: t,
            outerHeight: e,
            padding: n,
        ...
        jt(a.fullSize, u, d, m),
        jt(l, u, d, m),
        jt(c, u, d, m) && jt(l, u, d, m),
        Rr(u),
        Xi(a.leftAndTop, u, d, m),
        u.x += u.w,
        u.y += u.h,
        Xi(a.rightAndBottom, u, d, m),
        i.chartArea = {
            left: u.left,
            top: u.top,
            right: u.left + u.w,
...
function Nr(i, t, e) {
    i && i.addEventListener(t, e, Js)
}
function jr(i, t, e) {
    i && i.canvas && i.canvas.removeEventListener(t, e, Js)
}
function Vr(i, t) {
...
function $r(i, t, e) {
    const s = i.canvas
      , n = new MutationObserver(o => {
        let r = !1;
        for (const a of o)
            r = r || Ce(a.addedNodes, s),
            r = r && !Ce(a.removedNodes, s);
        r && e()
    }
    );
...
function Ur(i, t) {
    ee.size || window.addEventListener("resize", tn),
    ee.set(i, t)
}
function Xr(i) {
    ee.delete(i),
    ee.size || window.removeEventListener("resize", tn)
}
function Kr(i, t, e) {
    const s = i.canvas
      , n = s && ui(s);
...
function Zr(i) {
    return !fi() || typeof OffscreenCanvas < "u" && i instanceof OffscreenCanvas ? Br : Gr
}
class at {
    constructor() {
        O(this, "x");
...
function Qr(i, t) {
    ...
    if (r > 0) {
        ...
        for (pe(t, c, h, I(u) ? 0 : a - u, a),
        d = 0,
        f = r - 1; d < f; d++)
            pe(t, c, h, o[d], o[d + 1]);
        return pe(t, c, h, l, I(u) ? t.length : l + u),
        c
    }
    return pe(t, c, h),
    c
...
const na = i => i === "left" ? "right" : i === "right" ? "left" : i
  , Gi = (i, t, e) => t === "top" || t === "left" ? i[t] + e : i[t] - e
  , Zi = (i, t) => Math.min(t || i, i);
function Qi(i, t) {
    const e = []
      , s = i.length / t
      , n = i.length;
...
function ca(i, t, e) {
    let s = oi(i);
    return (e && t !== "right" || !e && t === "right") && (s = na(s)),
    s
}
function ha(i, t, e, s) {
    ...
    if (i.isHorizontal()) {
        ...
        C(e)) {
            ...
            e === "center" ? m = (c.bottom + c.top) / 2 + g - t : m = Gi(i, e, t);
        f = a - o
    } else {
        if (C(e)) {
            const b = Object.keys(e)[0]
            ...
            e === "center" ? u = (c.left + c.right) / 2 - p + t : u = Gi(i, e, t);
        m = W(s, r, n),
        d = e === "left" ? -Z : Z
    }
    return {
...
class Lt extends at {
    ...
    getUserBounds() {
        ...
        return t = J(t, Number.POSITIVE_INFINITY),
    ...
    update(t, e, s) {
        ...
        this._range = Do(this, o, n),
        this._dataLimitsCached = !0),
        this.beforeBuildTicks(),
        this.ticks = this.buildTicks() || [],
        this.afterBuildTicks();
        const l = a < this.ticks.length;
        this._convertTicksToLabels(l ? Qi(this.ticks, a) : this.ticks),
        this.configure(),
        this.beforeCalculateLabelRotation(),
        this.calculateLabelRotation(),
        this.afterCalculateLabelRotation(),
        r.display && (r.autoSkip || r.source === "auto") && (this.ticks = Qr(this, this.ticks),
        this._labelSizes = null,
        this.afterAutoSkip()),
    ...
    generateTickLabels(t) {
        ...
        n = t.length; s < n; s++)
            o = t[s],
            o.label = F(e.callback, [o.value, s, t], this)
    }
    ...
    calculateLabelRotation() {
        const t = this.options
          , e = t.ticks
          , s = Zi(this.ticks.length, t.ticks.maxTicksLimit)
          , n = e.minRotation || 0
          , o = e.maxRotation;
        let r = n, a, l, c;
        ...
        d + 6 > a && (a = u / (s - (t.offset ? .5 : 1)),
        l = this.maxHeight - Bt(t.grid) - e.padding - Ji(t.title, this.chart.options.font),
        c = Math.sqrt(d * d + f * f),
        r = Kn(Math.min(Math.asin(X((h.highest.height + 6) / a, -1, 1)), Math.asin(X(l / c, -1, 1)) - Math.asin(X(f / c, -1, 1)))),
    ...
    fit() {
        ...
        if (r) {
            ...
            t.height = Bt(o) + l) : (t.height = this.maxHeight,
            t.width = Bt(o) + l),
    ...
    _calculatePadding(t, e, s, n) {
        ...
        if (this.isHorizontal()) {
            ...
            let f = 0
              , u = 0;
            l ? c ? (f = n * t.width,
            u = s * e.height) : (f = s * t.height,
            u = n * e.width) : o === "start" ? u = e.width : o === "end" ? f = t.width : o !== "inner" && (f = t.width / 2,
            u = e.width / 2),
    ...
    _computeLabelSizes(t, e, s) {
        const {ctx: n, _longestTextCache: o} = this
          , r = []
          , a = []
          , l = Math.floor(e / Zi(e, s));
        let c = 0, h = 0, d, f, u, m, g, p, b, x, v, w, _;
        for (d = 0; d < e; d += l) {
            if (m = t[d].label,
            ...
            v = w = 0,
            !I(m) && !E(m))
                v = Ci(n, b.data, b.gc, v, m),
                w = x;
            else if (E(m))
                for (f = 0,
                u = m.length; f < u; ++f)
                    _ = m[f],
                    !I(_) && !E(_) && (v = Ci(n, b.data, b.gc, v, _),
                    w += x);
            r.push(v),
            a.push(w),
            c = Math.max(v, c),
    ...
    getPixelForDecimal(t) {
        ...
        return Zn(this._alignToPixels ? pt(this.chart, e, 0) : e)
    }
    ...
    _computeGridLineItems(t) {
        ...
        if (r === "top")
            ...
            if (r === "center")
                ...
                const H = Object.keys(r)[0]
                  , Y = r[H];
                x = b(this.chart.scales[H].getPixelForValue(Y))
            }
            D = t.top,
            j = t.bottom,
            k = x + p,
        ...
        for (v = 0; v < d; v += z) {
            const H = this.getContext(v)
              ...
              , ft = Y.tickColor
              , Ft = Y.tickBorderDash || []
              , ut = Y.tickBorderDashOffset;
            w = oa(this, v, l),
            w !== void 0 && (_ = pt(s, w, ne),
            c ? S = y = T = A = _ : k = M = D = j = _,
            u.push({
                tx1: S,
                ty1: k,
                tx2: y,
    ...
    _computeLabelItems(t) {
        const e = this.axis
          ...
          , p = [];
        let b, x, v, w, _, S, k, y, M, T, D, A, j = "middle";
        if (n === "top")
            S = this.bottom - m,
            ...
            if (n === "center")
                ...
                const z = Object.keys(n)[0]
                  , H = n[z];
                S = this.chart.scales[z].getPixelForValue(H) + u
            }
            k = this._getXAxisLabelAlignment()
        } else if (e === "y") {
            if (n === "center")
        ...
        x = a.length; b < x; ++b) {
            ...
            y = this.getPixelForTick(b) + o.labelOffset,
            M = this._resolveTickFontOptions(b),
            T = M.lineHeight,
            D = E(w) ? w.length : 1;
            const H = D / 2
              , Y = z.color
              , se = z.textStrokeColor
              , ne = z.textStrokeWidth;
            let Mt = k;
            r ? (_ = y,
            k === "inner" && (b === x - 1 ? Mt = this.options.reverse ? "left" : "right" : b === 0 ? Mt = this.options.reverse ? "right" : "left" : Mt = "center"),
            n === "top" ? c === "near" || g !== 0 ? A = -D * T + T / 2 : c === "center" ? A = -Q.highest.height / 2 - H * T + T : A = -Q.highest.height + T / 2 : c === "near" || g !== 0 ? A = T / 2 : c === "center" ? A = Q.highest.height / 2 - H * T : A = Q.highest.height - D * T,
            d && (A *= -1),
            g !== 0 && !z.showLabelBackdrop && (_ += T / 2 * Math.sin(g))) : (S = y,
            A = (1 - D) * T / 2);
            let oe;
            if (z.showLabelBackdrop) {
                const Ot = G(z.backdropPadding)
                  , It = Q.heights[b]
                  , ft = Q.widths[b];
                let Ft = A - Ot.top
                  , ut = 0 - Ot.left;
    ...
    drawTitle() {
        ...
        e === "bottom" || e === "center" || C(e) ? (l += r.bottom,
        E(s.text) && (l += o.lineHeight * (s.text.length - 1))) : l += r.top;
...
class me {
    ...
    unregister(t) {
        const e = this.items
          ...
          , n = this.scope;
        s in e && delete e[s],
        n && s in R[n] && (delete R[n][s],
        this.override && delete kt[s])
    }
}
function da(i, t, e) {
    const s = Zt(Object.create(null), [e ? R.get(e) : {}, R.get(t), i.defaults]);
    R.set(t, s),
    i.defaultRoutes && fa(t, i.defaultRoutes),
...
class ga {
    constructor() {
        this.controllers = new me(qt,"datasets",!0),
        this.elements = new me(at,"elements"),
        this.plugins = new me(Object,"plugins"),
        this.scales = new me(Lt,"scales"),
...
function Ze(i, ...t) {
    if (ts(i))
        return i;
    for (const e of t) {
        const s = e.axis || wa(e.position) || i.length > 1 && ts(i[0].toLowerCase());
        if (s)
            return s
    }
...
function Sa(i, t) {
    ...
    return Object.keys(s).forEach(r => {
        ...
        const l = Ze(r, a, ka(r, i), R.scales[a.type])
          , c = va(l, n)
          , h = e.scales || {};
...
class Oa {
    ...
    datasetScopeKeys(t) {
        return be(t, () => [[`datasets.${t}`, ""]])
    }
    datasetAnimationScopeKeys(t, e) {
        return be(`${t}.transition.${e}`, () => [[`datasets.${t}.transitions.${e}`, `transitions.${e}`], [`datasets.${t}`, ""]])
    }
    datasetElementScopeKeys(t, e) {
        return be(`${t}-${e}`, () => [[`datasets.${t}.elements.${e}`, `datasets.${t}`, `elements.${e}`, ""]])
    }
    pluginScopeKeys(t) {
        const e = t.id
          , s = this.type;
        return be(`${s}-plugin-${e}`, () => [[`plugins.${e}`, ...t.additionalOptionScopes || []]])
    }
    _cachedScopes(t, e) {
    ...
    getOptionScopes(t, e, s) {
        ...
        e.forEach(h => {
            t && (l.add(t),
            h.forEach(d => Ht(l, t, d))),
            h.forEach(d => Ht(l, n, d)),
            h.forEach(d => Ht(l, kt[o] || {}, d)),
            h.forEach(d => Ht(l, R, d)),
            h.forEach(d => Ht(l, Xe, d))
        }
        );
...
const Da = i => C(i) && Object.getOwnPropertyNames(i).some(t => dt(i[t]));
function Pa(i, t) {
    const {isScriptable: e, isIndexable: s} = Ws(i);
    for (const n of t) {
        const o = e(n)
          , r = s(n)
          , a = (r || o) && i[n];
        if (o && (dt(a) || Da(a)) || r && E(a))
            return !0
    }
    return !1
}
var Ca = "4.5.0";
const Ta = ["top", "bottom", "left", "right", "chartArea"];
function ns(i, t) {
    return i === "top" || i === "bottom" || Ta.indexOf(i) === -1 && t === "x"
}
function os(i, t) {
    return function(e, s) {
...
function on(i) {
    return fi() && typeof i == "string" ? i = document.getElementById(i) : i && i.length && (i = i[0]),
...
class xt {
    ...
    constructor(t, e) {
        ...
        this.platform = new (s.platform || Zr(n)),
        ...
        this.scales = {},
        this._plugins = new pa,
        this.$proxies = {},
        this._hiddenIndices = {},
        this.attached = !1,
        this._animationsDisabled = void 0,
        this.$context = void 0,
        this._doResize = io(d => this.update(d), r.resizeDelay || 0),
        this._dataChanges = [],
        we[this.id] = this,
        !a || !l) {
        ...
        nt.listen(this, "complete", rs),
        nt.listen(this, "progress", Aa),
        this._initialize(),
    ...
    _initialize() {
        ...
        this.options.responsive ? this.resize() : Ii(this, this.options.devicePixelRatio),
        this.bindEvents(),
        this.notifyPlugins("afterInit"),
        this
    }
    clear() {
        return Ti(this.canvas, this.ctx),
        this
    }
    stop() {
        return nt.stop(this),
    ...
    _resize(t, e) {
        ...
        this._aspectRatio = this.aspectRatio,
        Ii(this, a, !0) && (this.notifyPlugins("resize", {
            size: r
        }),
    ...
    buildOrUpdateScales() {
        ...
        L(o, r => {
            const a = r.options
              ...
              , c = Ze(l, a)
              , h = P(a.type, r.dtype);
            (a.position === void 0 || ns(a.position, c) !== ns(r.dposition)) && (a.position = r.dposition),
            n[l] = !0;
            let d = null;
    ...
    buildOrUpdateControllers() {
        ...
        n = e.length; s < n; s++) {
            ...
            r.type = a,
            r.indexAxis = o.indexAxis || Ge(a, this.options),
            r.order = o.order || 0,
            r.index = s,
            r.label = "" + o.label,
    ...
    _checkEventBindings() {
        const t = this.options
          ...
          , s = new Set(t.events);
        (!yi(e, s) || !!this._responsiveListeners !== t.responsive) && (this.unbindEvents(),
        this.bindEvents())
    }
    ...
    render() {
        this.notifyPlugins("beforeRender", {
            cancelable: !0
        }) !== !1 && (nt.has(this) ? this.attached && !nt.running(this) && nt.start(this) : (this.draw(),
        rs({
            chart: this
        })))
    }
    ...
    _drawDataset(t) {
        const e = this.ctx
          ...
          , n = hr(this, t);
        this.notifyPlugins("beforeDatasetDraw", s) !== !1 && (n && ai(e, n),
        t.controller.draw(),
        n && li(e),
        s.cancelable = !1,
...
O(xt, "getChart", as);
function ls() {
    return L(xt.instances, i => i._plugins.invalidate())
}
function rn(i, t, e=t) {
...
function za(i) {
    return i.stepped ? bo : i.tension || i.cubicInterpolationMode === "monotone" ? _o : Fa
}
function an(i, t, e={}) {
    const s = i.length
...
function Ra(i, t, e, s) {
    const {points: n, options: o} = t
      , {count: r, start: a, loop: l, ilen: c} = an(n, e, s)
      , h = za(o);
    let {move: d=!0, reverse: f} = s || {}, u, m, g;
    for (u = 0; u <= c; ++u)
        m = n[(a + (f ? c - u : u)) % r],
        !m.skip && (d ? (i.moveTo(m.x, m.y),
        d = !1) : h(i, g, m, f, o.stepped),
        g = m);
    return l && (m = n[(a + (f ? c : 0)) % r],
    h(i, g, m, f, o.stepped)),
    !!l
}
function Ea(i, t, e, s) {
    const n = t.points
      , {count: o, start: r, ilen: a} = an(n, e, s)
      , {move: l=!0, reverse: c} = s || {};
    let h = 0, d = 0, f, u, m, g, p, b;
    const x = w => (r + (c ? a - w : w)) % o
      , v = () => {
        g !== p && (i.lineTo(h, p),
        i.lineTo(h, g),
        i.lineTo(h, b))
...
function Qe(i) {
    ...
    return !i._decimated && !i._loop && !t.tension && t.cubicInterpolationMode !== "monotone" && !t.stepped && !e ? Ea : Ra
}
function Ba(i) {
    return i.stepped ? Zo : i.tension || i.cubicInterpolationMode === "monotone" ? Qo : _t
}
function Ha(i, t, e, s) {
    let n = t._path;
...
const Na = typeof Path2D == "function";
function ja(i, t, e, s) {
    Na && !t.options.segment ? Ha(i, t, e, s) : Wa(i, t, e, s)
}
class _e extends at {
    constructor(t) {
        super(),
    ...
    get segments() {
        return this._segments || (this._segments = rr(this, this.options.segment))
    }
    first() {
    ...
    interpolate(t, e) {
        ...
        h = r.length; c < h; ++c) {
            ...
            const g = Math.abs((n - u[e]) / (m[e] - u[e]))
              , p = l(u, m, g, s.stepped);
            p[e] = t[e],
            a.push(p)
        }
...
class $e extends at {
    ...
    draw(e, s) {
        ...
        this.skip || n.radius < .1 || !Jt(this, s, this.size(n) / 2) || (e.strokeStyle = n.borderColor,
        e.lineWidth = n.borderWidth,
        e.fillStyle = n.backgroundColor,
        Ke(e, n, this.x, this.y))
    }
    getRange() {
...
const hs = (i, t) => {
  ...
  , Va = (i, t) => i !== null && t !== null && i.datasetIndex === t.datasetIndex && i.index === t.index;
class ds extends at {
    constructor(t) {
        super(),
        this._added = !1,
    ...
    fit() {
        ...
        const s = t.labels
          ...
          , {boxWidth: a, itemHeight: l} = hs(s, o);
        let c, h;
        e.font = n.string,
    ...
    _fitCols(t, e, s, n) {
        ...
        return this.legendItems.forEach( (p, b) => {
            const {itemWidth: x, itemHeight: v} = $a(s, e, o, p, n);
            b > 0 && u + v + 2 * a > h && (d += f + a,
            c.push({
                width: f,
                height: u
    ...
    adjustHitBoxes() {
        ...
        const t = this._computeTitleHeight()
          ...
          , r = Pt(o, this.left, this.width);
        if (this.isHorizontal()) {
            let a = 0
              , l = W(s, this.left + n, this.right - this.lineWidths[a]);
            for (const c of e)
                a !== c.row && (a = c.row,
                l = W(s, this.left + n, this.right - this.lineWidths[a])),
                c.top += this.top + t + n,
            ...
            let a = 0
              , l = W(s, this.top + t + n, this.bottom - this.columnSizes[a].height);
            for (const c of e)
                c.col !== a && (a = c.col,
                l = W(s, this.top + t + n, this.bottom - this.columnSizes[a].height)),
                c.top = l,
    ...
    _draw() {
        const {options: t, columnSizes: e, lineWidths: s, ctx: n} = this
          , {align: o, labels: r} = t
          , a = R.color
          , l = Pt(t.rtl, this.left, this.width)
          , c = N(r.font)
          , {padding: h} = r
          , d = c.size
          , f = d / 2;
        ...
        n.lineWidth = .5,
        n.font = c.string;
        const {boxWidth: m, boxHeight: g, itemHeight: p} = hs(r, d)
          , b = function(S, k, y) {
            if (isNaN(m) || m <= 0 || isNaN(g) || g < 0)
                return;
            n.save();
            const M = P(y.lineWidth, 1);
            if (n.fillStyle = P(y.fillStyle, a),
            n.lineCap = P(y.lineCap, "butt"),
            n.lineDashOffset = P(y.lineDashOffset, 0),
            n.lineJoin = P(y.lineJoin, "miter"),
            n.lineWidth = M,
            n.strokeStyle = P(y.strokeStyle, a),
            n.setLineDash(P(y.lineDash, [])),
            r.usePointStyle) {
                const T = {
                  ...
                  , D = l.xPlus(S, m / 2)
                  , A = k + f;
                Bs(n, T, D, A, r.pointStyleWidth && m)
            } else {
                const T = k + Math.max((d - g) / 2, 0)
                  , D = l.leftForLtr(S, m)
                  , A = Kt(y.borderRadius);
                n.beginPath(),
                Object.values(A).some(j => j !== 0) ? qe(n, {
                    x: D,
                    y: T,
                    w: m,
                    h: g,
        ...
        v ? u = {
            x: W(o, this.left + h, this.right - s[0]),
            y: this.top + h + w,
            line: 0
        } : u = {
            x: this.left + h,
            y: W(o, this.top + w + h, this.bottom - e[0].height),
            line: 0
        },
        Ys(this.ctx, t.textDirection);
        const _ = p + h;
        this.legendItems.forEach( (S, k) => {
            n.strokeStyle = S.fontColor,
            n.fillStyle = S.fontColor;
            const y = n.measureText(S.text).width
              , M = l.textAlign(S.textAlign || (S.textAlign = r.textAlign))
              , T = m + f + y;
            let D = u.x
              , A = u.y;
            l.setWidth(this.width),
            v ? k > 0 && D + T + h > this.right && (A = u.y += _,
            u.line++,
            D = u.x = W(o, this.left + h, this.right - s[u.line])) : k > 0 && A + _ > this.bottom && (D = u.x = D + e[u.line].width + h,
            u.line++,
            A = u.y = W(o, this.top + w + h, this.bottom - e[u.line].height));
            const j = l.x(D);
            if (b(j, A, S),
            D = so(M, D + m + f, v ? D + T : this.right, t.rtl),
            x(l.x(D), A, S),
            v)
                u.x += T + h;
    ...
    drawTitle() {
        ...
        if (!e.display)
            return;
        const o = Pt(t.rtl, this.left, this.width)
          , r = this.ctx
          , a = e.position
          , l = s.size / 2
          , c = n.top + l;
        ...
        if (this.isHorizontal())
            ...
            h = this.top + c,
            d = W(t.align, d, this.right - f);
        else {
            const m = this.columnSizes.reduce( (g, p) => Math.max(g, p.height), 0);
            h = c + W(t.align, this.top, this.bottom - m - t.labels.padding - this._computeTitleHeight())
        }
        const u = W(a, d, d + f);
        r.textAlign = o.textAlign(oi(a)),
    ...
    _getLegendItemAt(t, e) {
        let s, n, o;
        if (Nt(t, this.left, this.right) && Nt(e, this.top, this.bottom)) {
            for (o = this.legendHitBoxes,
            s = 0; s < o.length; ++s)
                if (n = o[s],
                Nt(t, n.left, n.left + n.width) && Nt(e, n.top, n.top + n.height))
    ...
    handleEvent(t) {
        ...
        if (t.type === "mousemove" || t.type === "mouseout") {
            ...
            s && F(e.onClick, [t, s, this], this)
    }
}
function $a(i, t, e, s, n) {
    const o = Ya(s, i, t, e)
      , r = Ua(n, s, t.lineHeight);
    return {
        itemWidth: o,
        itemHeight: r
    }
...
function Ua(i, t, e) {
    let s = i;
    return typeof t.text != "string" && (s = ln(t, e)),
    s
}
function ln(i, t) {
...
class cn extends at {
    ...
    update(t, e) {
        ...
        const o = n * N(s.font).lineHeight + this._padding.height;
    ...
    _drawArgs(t) {
        const {top: e, left: s, bottom: n, right: o, options: r} = this
          , a = r.align;
        let l = 0, c, h, d;
        return this.isHorizontal() ? (h = W(a, s, o),
        d = e + t,
...
function tt(i, t) {
    return t && (E(t) ? Array.prototype.push.apply(i, t) : i.push(t)),
    i
}
function ot(i) {
...
function fs(i, t) {
    ...
    let g = m.height
      , p = 0
      , b = s.reduce( (w, _) => w + _.before.length + _.lines.length + _.after.length, 0);
    ...
    b) {
        ...
        g += u * w + (b - u) * l.lineHeight + (b - 1) * t.bodySpacing
    }
    f && (g += t.footerMarginTop + f * h.lineHeight + (f - 1) * t.footerSpacing);
    let x = 0;
    const v = function(w) {
        p = Math.max(p, e.measureText(w).width + x)
    };
    return e.save(),
    e.font = c.string,
    L(i.title, v),
    e.font = l.string,
    L(i.beforeBody.concat(i.afterBody), v),
...
function us(i, t, e) {
    const s = e.yAlign || t.yAlign || Ga(i, e);
    return {
        xAlign: e.xAlign || t.xAlign || Qa(i, t, e, s),
        yAlign: s
    }
}
function Ja(i, t) {
...
function V(i, t, e, s) {
    ...
    return typeof n > "u" ? hn[t].call(e, s) : n
}
class Je extends at {
    constructor(t) {
        super(),
    ...
    getContext() {
        return this.$context || (this.$context = el(this.chart.getContext(), this, this._tooltipItems))
    }
    getTitle(t, e) {
        const {callbacks: s} = e
          , n = V(s, "beforeTitle", this, t)
          , o = V(s, "title", this, t)
          , r = V(s, "afterTitle", this, t);
        let a = [];
        return a = tt(a, ot(n)),
        a = tt(a, ot(o)),
        a = tt(a, ot(r)),
    ...
    getBeforeBody(t, e) {
        return ps(V(e.callbacks, "beforeBody", this, t))
    }
    getBody(t, e) {
        const {callbacks: s} = e
          , n = [];
        return L(t, o => {
            const r = {
              ...
              , a = ms(s, o);
            tt(r.before, ot(V(a, "beforeLabel", this, o))),
            tt(r.lines, V(a, "label", this, o)),
            tt(r.after, ot(V(a, "afterLabel", this, o))),
            n.push(r)
        }
        ),
        n
    ...
    getAfterBody(t, e) {
        return ps(V(e.callbacks, "afterBody", this, t))
    }
    getFooter(t, e) {
        const {callbacks: s} = e
          , n = V(s, "beforeFooter", this, t)
          , o = V(s, "footer", this, t)
          , r = V(s, "afterFooter", this, t);
        let a = [];
        return a = tt(a, ot(n)),
        a = tt(a, ot(o)),
        a = tt(a, ot(r)),
    ...
    _createItems(t) {
        ...
        for (l = 0,
        c = e.length; l < c; ++l)
            a.push(qa(this.chart, e[l]));
        return t.filter && (a = a.filter( (h, d, f) => t.filter(h, d, f, s))),
        t.itemSort && (a = a.sort( (h, d) => t.itemSort(h, d, s))),
        L(a, h => {
            const d = ms(t.callbacks, h);
            n.push(V(d, "labelColor", this, h)),
            o.push(V(d, "labelPointStyle", this, h)),
            r.push(V(d, "labelTextColor", this, h))
        }
        ),
        this.labelColors = n,
    ...
    update(t, e) {
        ...
        if (!n.length)
            ...
            const a = Vt[s.position].call(this, n, this._eventPosition);
    ...
    getCaretPosition(t, e, s) {
        ...
        v = w - r,
        _ = w + r),
        x = p) : (n === "left" ? b = f + Math.max(l, h) + r : n === "right" ? b = f + m - Math.max(c, d) - r : b = this.caretX,
        o === "top" ? (v = u,
        w = v - r,
        p = b - r,
        x = b + r) : (v = u + g,
    ...
    drawTitle(t, e, s) {
        ...
        if (o) {
            ...
            for (t.x = xe(this, s.titleAlign, s),
    ...
    _drawColorBox(t, e, s, n, o) {
        ...
        if (o.usePointStyle) {
            ...
            t.lineWidth = C(r.borderWidth) ? Math.max(...Object.values(r.borderWidth)) : r.borderWidth || 1,
            t.strokeStyle = r.borderColor,
            t.setLineDash(r.borderDash || []),
            t.lineDashOffset = r.borderDashOffset || 0;
            const g = n.leftForLtr(f, c)
              , p = n.leftForLtr(n.xPlus(f, 1), c - 2)
              , b = Kt(r.borderRadius);
            Object.values(b).some(x => x !== 0) ? (t.beginPath(),
            t.fillStyle = o.multiKeyBackground,
            qe(t, {
                x: g,
                y: m,
    ...
    drawBody(t, e, s) {
        ...
        let f = d.lineHeight
          , u = 0;
        const m = Pt(s.rtl, this.x, this.width)
          , g = function(y) {
            e.fillText(y, m.x(t.x + u), t.y + f / 2),
            t.y += f + o
        }
          , p = m.textAlign(r);
        let b, x, v, w, _, S, k;
        ...
        L(this.beforeBody, g),
        u = a && p !== "right" ? r === "center" ? c / 2 + h : c + 2 + h : 0,
        w = 0,
        S = n.length; w < S; ++w) {
            for (b = n[w],
            ...
            L(b.before, g),
            v = b.lines,
            a && v.length && (this._drawColorBox(e, t, w, m, s),
    ...
    drawFooter(t, e, s) {
        ...
        if (o) {
            ...
            for (t.x = xe(this, s.footerAlign, s),
    ...
    drawBackground(t, e, s, n) {
        const {xAlign: o, yAlign: r} = this
          , {x: a, y: l} = t
          , {width: c, height: h} = s
          , {topLeft: d, topRight: f, bottomLeft: u, bottomRight: m} = Kt(n.cornerRadius);
        e.fillStyle = n.backgroundColor,
    ...
    _updateAnimationTarget(t) {
        const e = this.chart
          ...
          , o = s && s.y;
        if (n || o) {
            const r = Vt[t.position].call(this, this._active, this._eventPosition);
            if (!r)
                return;
            const a = this._size = fs(this, t)
...
const il = (i, t, e, s) => (typeof t == "string" ? (e = i.push(t) - 1,
s.unshift({
    index: e,
    label: t
})) : isNaN(t) && (e = null),
...
const nl = (i, t) => i === null ? null : X(Math.round(i), 0, t);
function bs(i) {
...
class _s extends Lt {
    ...
    parse(t, e) {
        if (I(t))
            return null;
        const s = this.getLabels();
        return e = isFinite(e) && s[e] === t ? e : sl(s, t, P(e, t), this._addedLabels),
        nl(e, s.length - 1)
    }
    determineDataLimits() {
...
function ol(i, t) {
    ...
    M = Math.ceil(p / _) - Math.floor(g / _),
    M > m && (_ = wi(M * _ / m / u) * u),
    I(l) || (S = Math.pow(10, l),
    _ = Math.ceil(_ * S) / S),
    n === "ticks" ? (k = Math.floor(g / _) * _,
    y = Math.ceil(p / _) * _) : (k = g,
    y = p),
    b && x && o && Un((a - r) / o, _ / 1e3) ? (M = Math.round(Math.min((a - r) / _, h)),
    _ = (a - r) / M,
    k = r,
    y = a) : v ? (k = b ? r : k,
    y = x ? a : y,
    M = c - 1,
    _ = (y - k) / M) : (M = (y - k) / _,
    Yt(M, Math.round(M), _ / 1e3) ? M = Math.round(M) : M = Math.ceil(M));
    const T = Math.max(ki(_), ki(k));
    S = Math.pow(10, I(l) ? T : l),
    k = Math.round(k * S) / S,
    y = Math.round(y * S) / S;
    let D = 0;
    for (b && (f && k !== r ? (e.push({
    ...
    k < r && D++,
    Yt(Math.round((k + D * _) * S) / S, r, xs(r, w, i)) && D++) : k < r && D++); D < M; ++D) {
        const A = Math.round((k + D * _) * S) / S;
        if (x && A > a)
            break;
        e.push({
            value: A
    ...
    return x && f && y !== a ? e.length && Yt(e[e.length - 1].value, a, xs(a, w, i)) ? e[e.length - 1].value = a : e.push({
        value: a
    }) : (!x || y === a) && e.push({
        value: y
    }),
...
class rl extends Lt {
    ...
    buildTicks() {
        ...
        const n = {
          ...
          , o = this._range || this
          , r = ol(n, o);
        return t.bounds === "ticks" && Xn(r, this, "value"),
        t.reverse ? (r.reverse(),
        this.start = this.max,
...
class ys extends rl {
    ...
    computeTickLimit() {
        const t = this.isHorizontal()
          ...
          , s = yt(this.options.ticks.minRotation)
...
function ws(i, t) {
    ...
    q(r) || (r = typeof s == "string" ? e.parse(r, s) : e.parse(r)),
    r === null ? null : (n && (r = n === "week" && (Qt(o) || o === !0) ? e.startOf(r, "isoWeek", o) : e.startOf(r, n)),
    +r)
}
function ks(i, t, e, s) {
    const n = $.length;
...
class Te extends Lt {
    ...
    init(t, e={}) {
        const s = t.time || (t.time = {})
          , n = this._adapter = new Mr._date(t.adapters.date);
        n.init(e),
    ...
    determineDataLimits() {
        ...
        o = q(o) && !isNaN(o) ? o : +e.endOf(Date.now(), s) + 1,
    ...
    buildTicks() {
        ...
        const o = this.min
          , r = this.max
          , a = Jn(n, o, r);
        return this._unit = e.unit || (s.autoSkip ? ks(e.minUnit, this.min, this.max, this._getLabelCapacity(o)) : al(this, a.length, e.minUnit, this.min, this.max)),
        this._majorUnit = !s.major.enabled || this._unit === "year" ? void 0 : ll(this._unit),
        this.initOffsets(n),
        t.reverse && a.reverse(),
        Ms(this, a, this._majorUnit)
    }
    afterAutoSkip() {
    ...
    _generate() {
        const t = this._adapter
          ...
          , n = this.options
          , o = n.time
          , r = o.unit || ks(o.minUnit, e, s, this._getLabelCapacity(e))
        ...
        for (f = d,
        u = 0; f < s; f = +t.add(f, a, r),
        u++)
            Ss(h, f, m);
        return (f === s || n.bounds === "ticks" || u === 1) && Ss(h, f, m),
        Object.keys(h).sort(vs).map(g => +g)
    }
    getLabelForValue(t) {
    ...
    _getLabelSize(t) {
        const e = this.options.ticks
          ...
          , n = yt(this.isHorizontal() ? e.maxRotation : e.minRotation)
          , o = Math.cos(n)
          , r = Math.sin(n)
    ...
    _getLabelCapacity(t) {
        const e = this.options.time
          ...
          , o = this._tickFormatFunction(t, 0, Ms(this, [t], this._majorUnit), n)
...
function ye(i, t, e) {
    ...
    e ? (t >= i[s].pos && t <= i[n].pos && ({lo: s, hi: n} = vt(i, "pos", t)),
    {pos: o, time: a} = i[s],
    {pos: r, time: l} = i[n]) : (t >= i[s].time && t <= i[n].time && ({lo: s, hi: n} = vt(i, "time", t)),
    {time: o, pos: a} = i[s],
    {time: r, pos: l} = i[n]);
    const c = r - o;
...
O(Os, "id", "timeseries"),
O(Os, "defaults", Te.defaults);
export {xt as C, ys as L, $e as P, _s as a, _e as b, We as c, ul as d, dl as e, fl as p};
