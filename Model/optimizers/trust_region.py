...
def replan(routes: list, base_car: CarState, solar_provider, wind_provider,
    ...
    return optimize(routes, car, solar_provider, wind_provider, cur_soc_pct,
...
def optimize(routes: list, car: CarState, solar_provider, wind_provider,
    ...
    base = tier1.guess_baseline(routes, car, solar_provider, wind_provider,
    ...
    for it in range(max_iters):
        ...
        per_day = tier2.sample_all_days(
            routes, car, solar_provider, wind_provider, s_center, plans,
        ...
        result = tier3.allocate(car, solar_provider, per_day, plans, start_soc_pct, start_day=start_day)
...
def extract_final_profiles(routes: list, base_car: CarState, solar_provider, 
                           wind_provider, optimize_result: dict, 
...
def fast_replan_today(route, base_car: CarState, solar_provider, wind_provider,
